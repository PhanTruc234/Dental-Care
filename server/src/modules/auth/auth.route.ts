...
import { authLimiter, createLimiter, emailLimiter, refreshLimiter } from "../../shared/configs/rate-limit.js";
...
router.post("/google", authLimiter, validate({ body: GoogleLoginBody }), authController.googleLogin);
